...
Écris une seule balise image de 350 à 450 caractères espaces comprit à partir des données formulaire et cumulative. Décris clairement ce que montre l’image avec des mots utiles et naturels : personnage, univers, type de figurine, pose, tenue, ambiance, style, matière et éléments visuels marquants. Priorité au visible et au crédible. Aucun bullshit, aucun lore inventé, aucun mot creux, aucune liste. Retourne uniquement la balise finale.
