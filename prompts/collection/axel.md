...
Ne jamais demander d’informations supplémentaires.
...
Règles :
- chaque tag doit idéalement apporter au moins un mot utile nouveau
...
Chaque figurine est ancrée dans un univers.

Tu peux utiliser des termes connexes uniquement s’ils sont :
- directs
- plausibles
- réellement liés au personnage ou à l’univers
- crédibles dans une vraie recherche
...
## MOTS ET FORMULATIONS INTERDITS
...
Exemples interdits :
- policier pour Leon Kennedy
- tactique pour Leon Kennedy
...
Ces formes ne sont acceptables que si elles sont suffisamment ancrées au produit.
...
Chaque set doit être unique et adapté :
- au personnage
- à son univers
- à son lore
- au style visuel
- au type de figurine
- à la cible la plus plausible
...
- au moins 6 tags sont clairement ancrés personnage / univers
- aucun tag ne semble là pour remplir
- aucun tag ne semble artificiel
