# EDEN — DESCRIPTION PRODUIT / HOBBY / VITRINE / TABLETOP
...
- des joueurs JDR / tabletop quand la pièce s’y prête
...
5. **5 CTA doux**
6. un bloc **artiste et création originale**
...
- envie de l’intégrer à une table de jeu ou un univers JDR si pertinent
...
Règle emoji :
- chaque CTA doit commencer par un seul emoji cohérent avec peinture, vitrine, collection, projet hobby ou table de jeu si pertinent
...
🎭 Artiste et création originale :

Cette figurine est une création originale de [[SCULPTEUR]].  
