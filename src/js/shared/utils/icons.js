(function initPipelineUIIcons(global) {
  ...
  const ICONS = Object.freeze({
    ...
    grip: '<path d="M9 5h.01"></path><path d="M9 12h.01"></path><path d="M9 19h.01"></path><path d="M15 5h.01"></path><path d="M15 12h.01"></path><path d="M15 19h.01"></path>',
    crop: '<path d="M6 2v14a2 2 0 0 0 2 2h14"></path><path d="M2 6h14a2 2 0 0 1 2 2v14"></path><path d="M10 14 21 3"></path>',
