...
(function initPipelineUIDataFormCatalogs(global) {
  global.PipelineUI = global.PipelineUI || {};
  global.PipelineUIData = global.PipelineUIData || {};
  global.PipelineUIDataFormCatalogs = global.PipelineUIDataFormCatalogs || {};

  const tabletopFormCatalogs = {
    archetypes: {
      primaryOptions: [
        { value: '', label: '— Choisir —' },
  ...
  const getCollectionMediaMap = () => Object.fromEntries(
    collectionFormCatalogs.media.map((entry) => [entry.value, entry])
  );
  ...
  Object.assign(global.PipelineUIDataFormCatalogs, {
    TABLETOP_FORM_CATALOGS: tabletopFormCatalogs,
    COLLECTION_FORM_CATALOGS: collectionFormCatalogs,
    dedupeOptions,
    getCollectionSubcategoriesForMedia,
  });

  Object.assign(global.PipelineUIData, {
    formCatalogs: global.PipelineUIDataFormCatalogs,
  });
})(window);
